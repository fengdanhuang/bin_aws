...
PROTOCOL=$2
PORT=$3
IP_PERMISSION='[{"IpProtocol":"icmp","FromPort":3,"ToPort":4,"IpRanges":[{"CidrIp":"0.0.0.0/0"}]}]'
...
echo "aws ec2 authorize-security-group-ingress --group-id $GROUP --ip-permissions $IP_PERMISSION"
aws ec2 authorize-security-group-ingress --group-id $GROUP_ID --ip-permissions $IP_PERMISSION
echo -e '\n'
